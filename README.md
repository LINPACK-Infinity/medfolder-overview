...
- supports OCR-based processing for noisy source files
- organizes diagnoses, medications, and document evidence
- builds longitudinal timeline views across multiple documents where supported
- surfaces explainability and review cues for human inspection
- supports privacy-sensitive, local-first workflows
...
- explainability and confidence cues
...
The main implementation remains private for now.
